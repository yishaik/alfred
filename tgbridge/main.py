...
def main():
    ...
    cmds = {
        ...
        "todo": handlers.cmd_todo,
        "expense": handlers.cmd_expense,
        "contact": handlers.cmd_contact,
        "plan": handlers.cmd_plan,
        "research": handlers.cmd_research,
        "cr": handlers.cmd_cr,
